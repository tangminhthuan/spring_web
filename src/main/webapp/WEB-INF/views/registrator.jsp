...
<!-- Navbar End -->
	...
	<form action="/registrator" method="POST" modelAttribute="acconnt"
		style="width: 50%; margin: auto; border: 1px solid black; border-radius: 10px; padding: 10px;">
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label" path="name">User name</label>
			<input type="text" class="form-control"
		...
		<div class="mb-3">
			...
			<input type="password" class="form-control"
				id="exampleInputPassword1" name="password" pattern=".{8,}" title="Must contain at least 8 or more characters"required>${err}
		</div>
		<div class="mb-3">
		...
		<div class="col">
			<div class="owl-carousel vendor-carousel">
				<div class="vendor-item border p-4">
					<img src="/resources/img/Xiaomi-Logo.jpg" alt="">
				</div>
				<div class="vendor-item border p-4">
					<img src="/resources/img/Samsung-logo.jpg" alt="">
				</div>
				<div class="vendor-item border p-4">
					<img src="/resources/img/Apple-Logo.png" alt="">
				</div>
				<div class="vendor-item border p-4">
					<img src="/resources/img/redmi-logo.png" alt="">
				</div>
				<div class="vendor-item border p-4">
					<img src="/resources/img/vivo-logo.png" alt="">
				</div>
				<div class="vendor-item border p-4">
					<img src="/resources/img/Oppo-Logo.png" alt="">
				</div>
				<div class="vendor-item border p-4">
					<img src="/resources/img/realme-logo.jpg" alt="">
				</div>
